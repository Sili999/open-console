...
def main():
    ...
    parser.add_argument('--no-sensor', action='store_true',
                        help='Run without fingerprint hardware (demo/dev mode)')
    ...
    leds.solid(0, 60, 80)   # dim cyan = system ready
    ...
    def on_login(slot_id, user_data):
        """Called in a daemon thread after SUCCESS screen display delay."""
